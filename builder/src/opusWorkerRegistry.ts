 ...
 * Kontext-Limits verifiziert April/Mai 2026.
 */
...
export const WORKER_REGISTRY: Record<string, WorkerConfig> = {
  ...
  qwen:        { provider: 'openrouter',  model: 'qwen/qwen3.7-max',          contextK: 1000 },
  ...
  grok:        { provider: 'xai',         model: 'grok-4.3',                  contextK: 1000 },
...
// Judge defaults stay cheap; GPT-5.5 remains available only when explicitly selected.
export const JUDGE_WORKER = 'glm51';
export const JUDGE_FALLBACK_WORKERS = ['deepseek', 'grok', 'gemini'] as const;
